...
Version  : 2.15.1
Release  : 59
URL      : https://files.pythonhosted.org/packages/35/1b/4438dbdcdbb26aa8d2d44ccfb2bc2e39f6c40fd49bbdae0082ea6c7ef1ff/pyicu-2.15.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/35/1b/4438dbdcdbb26aa8d2d44ccfb2bc2e39f6c40fd49bbdae0082ea6c7ef1ff/pyicu-2.15.1.tar.gz
...
%prep
%setup -q -n pyicu-2.15.1
cd %{_builddir}/pyicu-2.15.1
pushd ..
cp -a pyicu-2.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745243918
