...
Source0  : https://files.pythonhosted.org/packages/52/21/4e9b0a3ace3027fc63107fa2b5d6e66e321e104da071d787856962fbad52/PyICU-2.14.tar.gz
...
%prep
%setup -q -n pyicu-2.14
cd %{_builddir}/pyicu-2.14
pushd ..
cp -a pyicu-2.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730762109
